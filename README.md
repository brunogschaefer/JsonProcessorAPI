...
You can then execute your native executable with: `./target/json-processor-api-1.0.0-SNAPSHOT-runner`
...
- Camel MicroProfile Metrics ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/microprofile-metrics.html)): Expose metrics from Camel routes
